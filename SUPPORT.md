...
If you need help with `EricksonLopez.SharedKernel`, here is how you can get it:

## 1. Ask a Question (Discussions)

For "How do I do X?", "What's the best way to handle Y?", or architectural discussions, please use **GitHub Discussions**. 
This is the best place to get help from the community and the maintainers without cluttering the issue tracker.

👉 **[Go to GitHub Discussions](https://github.com/ericksonlopezf/dotnet-shared-kernel/discussions)**

## 2. Report a Bug (Issues)
...
Before asking a question, please check out these resources:
